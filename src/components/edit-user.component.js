...
export default class EditUser extends Component {
  ...
  componentDidMount() {
    axios.get('https://workout-backend-714h.onrender.com/userdetails/'+this.props.match.params.id)
      .then(response => {
        this.setState({
          user: response.data,
  ...
  onSubmit(e) {
    ...
    axios.post('https://workout-backend-714h.onrender.com/userdetails/update/', this.props.match.params.id)
